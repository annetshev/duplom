...
const API_URL = "http://172.20.10.5:8000/scientific_materials";
const API_UR = "http://172.20.10.5:8000/scientific_materials/download";
...
const Publications = () => {
  ...
  const [kind, setKind] = useState("Міжнародні");
  ...
  const filteredProjects = sortedProjects.filter(
    (project) =>
      ...
      project.kind &&
      project.kind.includes("Міжнародні") &&
